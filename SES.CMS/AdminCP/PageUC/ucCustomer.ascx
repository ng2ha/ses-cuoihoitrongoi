<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucCustomer.ascx.cs"
    Inherits="SES.CMS.AdminCP.PageUC.ucCustomer" %>
    ...
    <tr>
        <td>
            <asp:GridView ID="gvUser" runat="server" AutoGenerateColumns="False" BackColor="White"
                ...
                DataKeyNames="ID" OnPageIndexChanging="gvUser_PageIndexChanging" OnSelectedIndexChanged="gvUser_SelectedIndexChanged"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="username" HeaderText="Tên ĐN" />
                    ...
                    <asp:TemplateField>
                        <ItemTemplate>
                            <asp:ImageButton ID="btCreate" runat="server" CommandName="create" CommandArgument='<%#Eval("ID") %>'
                                ImageUrl="~/AdminCP/images/add_16x16.gif" />
                            <asp:ImageButton ID="btEdidft" runat="server" CommandName="editc" CommandArgument='<%#Eval("ID") %>'
                                ImageUrl="~/AdminCP/images/edit_16x16.gif" />
...
<asp:Panel ID="pnAD" runat="server" Visible="false">
    <div style="width: 49%; float: left; border-right: dotted 1px white;">
        <div class="contact-text">
            <a>Ten Dang Nhap: </a>
        </div>
        <input id="txtUser" class="contact-input" type="text"  runat="server" />
        
        <div class="contact-text">
            <a>MAt KHau </a>
        </div>
        <input id="txtPw" class="contact-input" type="text"  runat="server" />
