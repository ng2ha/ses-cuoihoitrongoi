...
namespace SES.CMS.DAL
{
    ...
    public class cmsArticleDAL : BaseDAL
    {
        ...
        public int Insert(cmsArticleDO objcmsArticleDO)
        {
            ...
            Sqlparam = new SqlParameter("@AllowVote", SqlDbType.Bit);
            Sqlparam.Value = objcmsArticleDO.AllowVote;
            Sqlcomm.Parameters.Add(Sqlparam);

            Sqlparam = new SqlParameter("@AllowComment", SqlDbType.Bit);
            Sqlparam.Value = objcmsArticleDO.AllowComment;
            Sqlcomm.Parameters.Add(Sqlparam);
        ...
        public cmsArticleDO Select(cmsArticleDO objcmsArticleDO)
        {
            ...
            if (ds != null && ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
            {
                ...
                if (!Convert.IsDBNull(dr["AllowVote"]))
                    objcmsArticleDO.AllowVote = Convert.ToBoolean(dr["AllowVote"]);

                if (!Convert.IsDBNull(dr["AllowComment"]))
                    objcmsArticleDO.AllowComment = Convert.ToBoolean(dr["AllowComment"]);
        ...
        public DataTable SelectFrontpage()
        {
            SqlCommand Sqlcomm = new SqlCommand();
            Sqlcomm.CommandType = CommandType.StoredProcedure;
            Sqlcomm.CommandText = "spcmsArticle_GetFrontPage";
        ...
        public DataTable SelectLastest(int GetNumber)
        {
            SqlCommand Sqlcomm = new SqlCommand();
            Sqlcomm.CommandType = CommandType.StoredProcedure;
            Sqlcomm.CommandText = "spcmsArticle_GetLastest";
            SqlParameter Sqlparam;


            Sqlparam = new SqlParameter("@GetNumber", SqlDbType.Int);
            Sqlparam.Value = GetNumber;
            Sqlcomm.Parameters.Add(Sqlparam);
        ...
        public DataTable Search(string Keyword)
        {
            SqlCommand Sqlcomm = new SqlCommand();
            Sqlcomm.CommandType = CommandType.StoredProcedure;
            Sqlcomm.CommandText = "dbo.sp_Search";
            SqlParameter Sqlparam;


            Sqlparam = new SqlParameter("@Keyword", SqlDbType.NVarChar);
            Sqlparam.Value = Keyword;
            Sqlcomm.Parameters.Add(Sqlparam);
