...
namespace SES.CMS.BL 
{
    public class cmsArticleBL 
    {
        ...
        {
            return objcmsArticleDAL.SelectFrontpage();
        }

        public DataTable SelectLastest(int num)
        {
            return objcmsArticleDAL.SelectLastest(num);
        }

        public DataTable Search(string Keyword)
        {
            return objcmsArticleDAL.Search(Keyword);
        }
    }
