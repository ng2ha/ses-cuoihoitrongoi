<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="WeddingScript.aspx.cs" Inherits="SES.CMS.WeddingScript" Title="Untitled Page" %>
        ...
        <div class="servicecontent">
            <div class="servicecontent-top">
                <div class="servicecontent-top-left">
                    <h1 class="h1style">KỊCH BẢN CƯỚI</h1>
                </div>
            ...
            <blockquote class="serviceintro">
                ...
                <br />
                <br />
                Mời bạn nhập Tên đăng nhập và Mật khẩu để xem và tham khảo Kịch bản cưới chúng tôi đã chuẩn bị.
                Nếu cần thêm thông tin hoặc cần tư vấn bạn gửi Email tại mục Liên hệ hoặc
